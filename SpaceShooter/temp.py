...
class GameController:
    def __init__(self, width = 1500, height = 800, multiplayer = None):
        self.Running = True
        ...
        if multiplayer != None:
            ...
            self.__sendMessage(
                ...
                'Ship': [self.player.currentPosition]
                })
            
            self.playerId = []

        self.otherPlayers = []
        self.allPlayers = [self.player]

        self.__messager =multiplayer    
...
while GC.Running:
    ...
    #print(Player1_Spaceship.position_x)
